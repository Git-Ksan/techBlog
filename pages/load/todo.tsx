...
export default function TodoApp() {
    ...
    return (
    <>
      <Layout title="Todo" key={"todo1"}>
      <HeaderOnly key={"todo2"}/>
        <Content  key={"todo3"}>
          <ContentsMainArea key={"todo4"}>
            <h1 className="contents-h1">Todoアプリ</h1>
            
            <TodoInput todoText={todoText} onChange={onChangeTodoText} onClick={onClickAddTodo} key={"todo5"}/>
